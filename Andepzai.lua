...
main.Size = UDim2.fromOffset(820,440)
main.Position = UDim2.fromScale(0.5,0.5) - UDim2.fromOffset(410,220)
...
top.Size = UDim2.fromOffset(820,70)
...
content.Size = UDim2.fromOffset(780,330)
content.Position = UDim2.fromOffset(20,90)
